...
describe('AuthService', () => {
  ...
  describe('verifiedPassword', () => {
    it('should return true for matching password', async () => {
      ...
      const result = await authService.verifiedPassword(
        plainPassword,
        storedPassword,
      );
  ...
  describe('validateLocalUser', () => {
    it('should validate and return user for correct credentials', async () => {
      ...
      identityRepository.createQueryBuilder.mockReturnValue(
        queryBuilder as any,
      );
      ...
      expect(identityRepository.createQueryBuilder).toHaveBeenCalledWith(
        'identity',
      );
  ...
  describe('validateOAuthLogin', () => {
    ...
    it('should create new user and identity when identity does not exist', async () => {
      ...
      userRepoInTransaction.createQueryBuilder.mockReturnValue(
        userQueryBuilder as any,
      );
  ...
  describe('register', () => {
    it('should register a new user successfully', async () => {
      ...
      jest
        .spyOn(authService, 'hashedPassword')
      ...
      expect(authService.hashedPassword).toHaveBeenCalledWith(
  ...
  describe('activeAccount', () => {
    ...
    it('should throw BadRequestException when token is invalid', async () => {
      ...
      await expect(authService.activeAccount(token)).rejects.toThrow(
        BadRequestException,
      );
      expect(logger.warn).toHaveBeenCalled();
    });
  ...
  describe('resetPassword', () => {
    it('should reset password with valid token', async () => {
      ...
      identityRepository.findOne.mockResolvedValue(
        identityWithResetToken as Identity,
      );
      identityRepository.save.mockResolvedValue(
        identityWithResetToken as Identity,
      );
  ...
  describe('registerSeeder', () => {
    ...
    it('should handle seeder registration errors', async () => {
      ...
      await expect(
        authService.registerSeeder(registerSeederDto),
